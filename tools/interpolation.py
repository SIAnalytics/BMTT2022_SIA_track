...
if __name__ == '__main__':
    data_root = '/workspace/Repro/ByteTrack/datasets/mot/train'
    txt_path = '/workspace/Repro/ByteTrack/YOLOX_outputs/yolox_x_source_only/track_results'
    save_path = '/workspace/Repro/ByteTrack/YOLOX_outputs/yolox_x_source_only/track_results_dti'
